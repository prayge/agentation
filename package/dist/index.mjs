...
import { useState as useState7, useCallback as useCallback5, useEffect as useEffect7, useLayoutEffect, useRef as useRef6 } from "react";
...
var IconLink = ({ size = 16 }) => /* @__PURE__ */ jsx(
  "svg",
  {
    width: size,
    height: size,
...
var IconTag = ({ size = 16 }) => /* @__PURE__ */ jsxs(
  "svg",
  {
    width: size,
    height: size,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("circle", { cx: "5.4", cy: "5.4", r: "0.9", fill: "currentColor" })
    ]
  }
);
var AnimatedBunny = ({
          ...
          return /* @__PURE__ */ jsxs5(
            "div",
            {
              ...
              children: [
                ...
                LINKABLE_TYPES.has(p.type) && /* @__PURE__ */ jsxs5("div", { className: styles_module_default3.placementActions, children: [
                  /* @__PURE__ */ jsxs5(
                    "button",
                    {
                      type: "button",
                  ...
                  /* @__PURE__ */ jsxs5(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx6(IconLink, { size: 11 }),
                        linkingId === p.id ? "Pick\u2026" : "Link to"
                      ]
                    }
                  )
                ] }),
                p.links && p.links.length > 0 && /* @__PURE__ */ jsx6("div", { className: styles_module_default3.placementLinks, children: p.links.map((link) => /* @__PURE__ */ jsxs5("span", { className: styles_module_default3.placementLink, children: [
                  /* @__PURE__ */ jsx6(IconLink, { size: 10 }),
...
function ComponentGrid({ activeType, onSelect, onDragStart, scrollRef, fadeClass, blankCanvas, query }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { ref: scrollRef, className: `${styles_module_default3.placeScroll} ${fadeClass || ""}`, children: [
    sections.length === 0 && /* @__PURE__ */ jsxs6("div", { className: styles_module_default3.paletteEmpty, children: [
      "No components match \u201C",
      query?.trim(),
      "\u201D"
    ] }),
    sections.map((section) => /* @__PURE__ */ jsxs6("div", { className: styles_module_default3.paletteSection, children: [
  ...
  return /* @__PURE__ */ jsxs6(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs6("div", { className: styles_module_default3.paletteSearch, children: [
          /* @__PURE__ */ jsx7("span", { className: styles_module_default3.paletteSearchIcon, children: /* @__PURE__ */ jsxs6("svg", { viewBox: "0 0 14 14", width: "14", height: "14", fill: "none", children: [
            /* @__PURE__ */ jsx7("circle", { cx: "6.25", cy: "6.25", r: "4.25", stroke: "currentColor", strokeWidth: "1.2" }),
            /* @__PURE__ */ jsx7("path", { d: "M9.4 9.4L12 12", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" })
          ] }) }),
          /* @__PURE__ */ jsx7(
            "input",
            {
          ...
          query && /* @__PURE__ */ jsx7(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx7("svg", { viewBox: "0 0 12 12", width: "12", height: "12", fill: "none", children: /* @__PURE__ */ jsx7("path", { d: "M3 3L9 9M9 3L3 9", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" }) })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs6(
...
function KeybindField({
  ...
  return /* @__PURE__ */ jsx13(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx13("span", { className: styles_module_default9.cycleButtonText, children: recording ? held ? `${held}\u2026` : "Press keys" : formatKeybind(value) }, recording ? "recording" : value)
    }
  );
}
function HoldKeyField({
  ...
  return /* @__PURE__ */ jsx13(
    "button",
    {
      ...
      className: `${styles_module_default9.keybindButton} ${recording ? styles_module_default9.keybindRecording : ""}`,
      onClick: () => setRecording((prev) => !prev),
      children: /* @__PURE__ */ jsx13("span", { className: styles_module_default9.cycleButtonText, children: recording ? "Hold a modifier" : formatHoldKey(value) }, recording ? "recording" : value)
    }
  );
}
              ...
              /* @__PURE__ */ jsxs12("div", { className: styles_module_default9.settingsSection, children: [
                /* @__PURE__ */ jsxs12("div", { className: styles_module_default9.settingsRow, children: [
                  /* @__PURE__ */ jsxs12("div", { className: styles_module_default9.settingsLabel, children: [
                    "Output Detail",
                    /* @__PURE__ */ jsx13(HelpTooltip, { content: "How much the copied output says about each note. Hover the button to read what the current level includes." })
                  ] }),
                  /* @__PURE__ */ jsx13(
                    Tooltip,
                    {
                ...
                /* @__PURE__ */ jsxs12(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs12("div", { className: styles_module_default9.settingsLabel, children: [
                        "Feedback Shortcut",
                        /* @__PURE__ */ jsx13(HelpTooltip, { content: "Shortcut that starts and stops feedback mode. Click, then press the keys you want \u2014 modifiers included. Escape cancels." })
                      ] }),
                      /* @__PURE__ */ jsx13(
                        KeybindField,
                        {
                ...
                /* @__PURE__ */ jsxs12(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs12("div", { className: styles_module_default9.settingsLabel, children: [
                        "Click Through",
                        /* @__PURE__ */ jsx13(HelpTooltip, { content: "Hold this key to suspend feedback mode and use the page normally \u2014 click a button, open a menu \u2014 without leaving feedback mode. Click, then hold the modifier you want. Backspace turns it off." })
                      ] }),
                      /* @__PURE__ */ jsx13(
                        HoldKeyField,
                        {
...
function PageFeedbackToolbarCSS({
  ...
  const [annotations, setAnnotations] = useState7([]);
  const [showMarkers, setShowMarkers] = useState7(true);
  const [isToolbarHidden, setIsToolbarHidden] = useState7(() => loadToolbarHidden());
  const [isToolbarHiding, setIsToolbarHiding] = useState7(false);
  ...
  const [markersVisible, setMarkersVisible] = useState7(false);
  const [markersExiting, setMarkersExiting] = useState7(false);
  const [hoverInfo, setHoverInfo] = useState7(null);
  const [hoverPosition, setHoverPosition] = useState7({ x: 0, y: 0 });
  const [pendingAnnotation, setPendingAnnotation] = useState7(null);
  const [copied, setCopied] = useState7(false);
  const [sendState, setSendState] = useState7("idle");
  const [cleared, setCleared] = useState7(false);
  const [isClearing, setIsClearing] = useState7(false);
  const [hoveredMarkerId, setHoveredMarkerId] = useState7(null);
  const [hoveredTargetElement, setHoveredTargetElement] = useState7(null);
  const [hoveredTargetElements, setHoveredTargetElements] = useState7([]);
  const [deletingMarkerId, setDeletingMarkerId] = useState7(null);
  const [renumberFrom, setRenumberFrom] = useState7(null);
  const [editingAnnotation, setEditingAnnotation] = useState7(
    null
  );
  const [editingTargetElement, setEditingTargetElement] = useState7(null);
  const [editingTargetElements, setEditingTargetElements] = useState7([]);
  const [scrollY, setScrollY] = useState7(0);
  const [isScrolling, setIsScrolling] = useState7(false);
  const [mounted, setMounted] = useState7(false);
  const [isFrozen, setIsFrozen] = useState7(false);
  const [showSettings, setShowSettings] = useState7(false);
  const [showSettingsVisible, setShowSettingsVisible] = useState7(false);
  const [settingsPage, setSettingsPage] = useState7(
    "main"
  );
  const [tooltipsHidden, setTooltipsHidden] = useState7(false);
  const [isDesignMode, setIsDesignMode] = useState7(false);
  const [designOverlayExiting, setDesignOverlayExiting] = useState7(false);
  const [designPlacements, setDesignPlacements] = useState7([]);
  const [activeDesignComponent, setActiveDesignComponent] = useState7(null);
  const designPlacementsLoaded = useRef6(false);
  const [blankCanvas, setBlankCanvas] = useState7(false);
  const [canvasReady, setCanvasReady] = useState7(false);
  const [canvasOpacity, setCanvasOpacity] = useState7(1);
  const [canvasPurpose, setCanvasPurpose] = useState7("new-page");
  const [wireframePurpose, setWireframePurpose] = useState7("");
  const [designInteracting, setDesignInteracting] = useState7(false);
  const [linkingPlacementId, setLinkingPlacementId] = useState7(null);
  const [pendingLink, setPendingLink] = useState7(null);
  const [pendingLinkExiting, setPendingLinkExiting] = useState7(false);
  const pickTargetRef = useRef6(null);
  const [clickThroughHeld, setClickThroughHeld] = useState7(false);
  const redispatchingClickRef = useRef6(false);
  const [rearrangeState, setRearrangeState] = useState7(null);
  ...
  const [designDeselectSignal, setDesignDeselectSignal] = useState7(0);
  const [rearrangeDeselectSignal, setRearrangeDeselectSignal] = useState7(0);
  const [designClearSignal, setDesignClearSignal] = useState7(0);
  const [rearrangeClearSignal, setRearrangeClearSignal] = useState7(0);
  ...
  const [isDrawMode, setIsDrawMode] = useState7(false);
  const [drawStrokes, setDrawStrokes] = useState7([]);
  const drawStrokesRef = useRef6(drawStrokes);
  drawStrokesRef.current = drawStrokes;
  const [hoveredDrawingIdx, setHoveredDrawingIdx] = useState7(null);
  ...
  const [tooltipSessionActive, setTooltipSessionActive] = useState7(false);
  const tooltipSessionTimerRef = useRef6(
    null
  );
  const [pendingMultiSelectElements, setPendingMultiSelectElements] = useState7([]);
  ...
  const [settings, setSettings] = useState7(() => {
    try {
  ...
  const [isDarkMode, setIsDarkMode] = useState7(true);
  const [showEntranceAnimation, setShowEntranceAnimation] = useState7(false);
  const toggleTheme = () => {
  ...
  const [connectionStatus, setConnectionStatus] = useState7(endpoint ? "connecting" : "disconnected");
  const [toolbarPosition, setToolbarPosition] = useState7(null);
  const [isDraggingToolbar, setIsDraggingToolbar] = useState7(false);
  const [dragStartPos, setDragStartPos] = useState7(null);
  const justFinishedToolbarDragRef = useRef6(false);
  const [animatedMarkers, setAnimatedMarkers] = useState7(
    /* @__PURE__ */ new Set()
  );
  const [exitingMarkers, setExitingMarkers] = useState7(/* @__PURE__ */ new Set());
  const [pendingExiting, setPendingExiting] = useState7(false);
  const [editExiting, setEditExiting] = useState7(false);
                ...
                /* @__PURE__ */ jsxs13(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs13("span", { className: `${styles_module_default4.buttonTooltip} ${styles_module_default4.toggleTooltip}`, children: [
                        "Start feedback mode",
                        settings.activationKey && /* @__PURE__ */ jsx14("span", { className: styles_module_default4.shortcut, children: formatKeybind(settings.activationKey) })
                      ] }),
