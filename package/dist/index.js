...
var IconLink = ({ size = 16 }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "svg",
  {
    width: size,
    height: size,
...
var IconTag = ({ size = 16 }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "5.4", cy: "5.4", r: "0.9", fill: "currentColor" })
    ]
  }
);
var AnimatedBunny = ({
...
var LINKABLE_TYPES = /* @__PURE__ */ new Set(["navigation"]);
var DEFAULT_SIZES = {
...
function DesignMode({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ...
      {
        ref: overlayRef,
        className: `${styles_module_default3.overlay} ${!isDarkMode ? styles_module_default3.light : ""} ${activeComponent ? styles_module_default3.placing : ""} ${passthrough ? styles_module_default3.passthrough : ""} ${linkingId ? styles_module_default3.picking : ""} ${exiting ? styles_module_default3.overlayExiting : ""} ${wireframe ? styles_module_default3.wireframe : ""}${extraClassName ? ` ${extraClassName}` : ""}`,
        "data-feedback-toolbar": true,
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "div",
            {
              ...
              children: [
                ...
                LINKABLE_TYPES.has(p.type) && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: styles_module_default3.placementActions, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
                    "button",
                    {
                      type: "button",
                      className: styles_module_default3.placementAction,
                      onMouseDown: (e) => e.stopPropagation(),
                      onClick: () => handleDoubleClick(p.id),
                      title: "Set the nav's own label",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(IconTag, { size: 11 }),
                        "Label"
                      ]
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
                    ...
                    {
                      type: "button",
                      className: `${styles_module_default3.placementAction} ${linkingId === p.id ? styles_module_default3.placementActionActive : ""}`,
                      onMouseDown: (e) => e.stopPropagation(),
                      onClick: () => onRequestLink?.(p.id),
                      title: "Point this nav at a component already on the page",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(IconLink, { size: 11 }),
                        linkingId === p.id ? "Pick\u2026" : "Link to"
                      ]
                    }
                  )
                ] }),
                p.links && p.links.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: styles_module_default3.placementLinks, children: p.links.map((link) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: styles_module_default3.placementLink, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(IconLink, { size: 10 }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                    ...
                    {
                      type: "button",
                      className: styles_module_default3.placementLinkRemove,
                      onMouseDown: (e) => e.stopPropagation(),
                      onClick: () => onChange(
                        placements.map(
                          (pl) => pl.id === p.id ? { ...pl, links: pl.links?.filter((l) => l.id !== link.id) } : pl
                        )
                      ),
                      title: "Remove link",
                      children: "\u2715"
...
function ComponentGrid({ activeType, onSelect, onDragStart, scrollRef, fadeClass, blankCanvas, query }) {
  const needle = query?.trim().toLowerCase() ?? "";
  const sections = needle ? COMPONENT_REGISTRY.map((section) => ({
    ...section,
    items: section.items.filter(
      (item) => item.label.toLowerCase().includes(needle) || item.type.toLowerCase().includes(needle)
    )
  })).filter((section) => section.items.length > 0) : COMPONENT_REGISTRY;
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { ref: scrollRef, className: `${styles_module_default3.placeScroll} ${fadeClass || ""}`, children: [
    sections.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: styles_module_default3.paletteEmpty, children: [
      "No components match \u201C",
      query?.trim(),
      "\u201D"
    ] }),
    sections.map((section) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: styles_module_default3.paletteSection, children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: styles_module_default3.paletteSearch, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: styles_module_default3.paletteSearchIcon, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", { viewBox: "0 0 14 14", width: "14", height: "14", fill: "none", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { cx: "6.25", cy: "6.25", r: "4.25", stroke: "currentColor", strokeWidth: "1.2" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M9.4 9.4L12 12", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            "input",
            {
              className: styles_module_default3.paletteSearchInput,
              type: "text",
          ...
          query && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            "button",
            {
              type: "button",
              className: styles_module_default3.paletteSearchClear,
              onClick: () => setQuery(""),
              "aria-label": "Clear search",
              children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { viewBox: "0 0 12 12", width: "12", height: "12", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M3 3L9 9M9 3L3 9", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" }) })
            }
          )
        ] }),
...
function formatPlacementLinks(c, indent, detailLevel) {
  let out = "";
...
`;
  c.links.forEach((link, i) => {
    ...
    out += `${indent}  ${i + 1}. ${name} \u2014 \`${Math.round(t.rect.width)}\xD7${Math.round(t.rect.height)}px\` at \`(${Math.round(t.rect.x)}, ${Math.round(t.rect.y)})\`
`;
...
var DEFAULT_ACTIVATION_KEY = "Mod+Shift+F";
...
function formatEventModifiers(e) {
  const apple = isApple();
  const parts = [];
...
var DEFAULT_CLICK_THROUGH_KEY = "Alt";
var HOLD_KEYS = ["Alt", "Shift", "Control", "Meta"];
function isHoldKey(key) {
  return HOLD_KEYS.includes(key);
}
function holdKeyFromEvent(e) {
  return isHoldKey(e.key) ? e.key : null;
}
function formatHoldKey(key) {
  if (!key) return "Off";
...
function matchesKeybind(e, bind, isTyping) {
  const parsed = parseKeybind(bind);
...
var OUTPUT_DETAIL_OPTIONS = [
  {
    value: "compact",
    label: "Compact",
    description: "One line per note \u2014 element, source file, your comment. No positions, no styles, no React names. Good for a quick punch list."
  },
  {
    value: "standard",
    label: "Standard",
    description: "Each note with its DOM path, source file and React component name. The default: enough for an agent to find the element and change it."
  },
  {
    value: "detailed",
    label: "Detailed",
    description: "Standard plus CSS classes, pixel position and size, and the text around the element. Reach for this when spacing or layout is the problem."
  },
  {
    value: "forensic",
    label: "Forensic",
    description: "Everything: full DOM path, computed styles, accessibility info, neighbouring elements, plus URL, user agent and timestamp. Largest output, slowest to read."
  }
];
...
function detectBrowser(ua) {
  ...
  const match = /(Firefox|Edg|OPR|Chrome|Safari)\/(\d+)/.exec(ua) ?? null;
...
function emulatedDeviceName(ua) {
...
function describeResponsive(ua, viewport, win, screen, maxTouchPoints) {
  ...
  if (mobileUA) {
    ...
    return emulated ? `device emulation \u2014 ${label} at ${viewport.width}\xD7${viewport.height}px` : `mobile browser \u2014 ${label}, ${viewport.width}\xD7${viewport.height}px viewport`;
  }
  ...
  if (maxTouchPoints > 0) {
    return `touch-capable desktop at ${viewport.width}\xD7${viewport.height}px`;
  }
  return `desktop at ${viewport.width}\xD7${viewport.height}px, roughly full-screen`;
}
...
function formatEnvironment(detailLevel = "standard") {
  const env = getEnvironmentInfo();
  if (!env) return "";
  if (detailLevel === "compact") {
    return `> ${env.browser} \xB7 ${env.os} \xB7 ${env.viewport.width}\xD7${env.viewport.height} \xB7 ${env.breakpoint}
`;
  }
  let out = "### Environment\n";
  out += `- Browser: ${env.browser} on ${env.os}
`;
  out += `- Viewport: \`${env.viewport.width}\xD7${env.viewport.height}px\` \xB7 DPR \`${env.dpr}\` \xB7 ${env.orientation}
`;
  out += `- Window: \`${env.window.width}\xD7${env.window.height}px\` \xB7 Screen: \`${env.screen.width}\xD7${env.screen.height}px\`
`;
...
function withEnvironment(markdown, detailLevel = "standard") {
...
function KeybindField({
  ...
  const [recording, setRecording] = (0, import_react8.useState)(false);
  const [held, setHeld] = (0, import_react8.useState)("");
  (0, import_react8.useEffect)(() => {
    ...
    const handleKeyUp = (e) => setHeld(formatEventModifiers(e));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    ...
    {
      type: "button",
      className: `${styles_module_default9.keybindButton} ${recording ? styles_module_default9.keybindRecording : ""}`,
      onClick: () => setRecording((prev) => !prev),
      children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: styles_module_default9.cycleButtonText, children: recording ? held ? `${held}\u2026` : "Press keys" : formatKeybind(value) }, recording ? "recording" : value)
    }
  );
}
function HoldKeyField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    "button",
    {
      ...
      className: `${styles_module_default9.keybindButton} ${recording ? styles_module_default9.keybindRecording : ""}`,
      onClick: () => setRecording((prev) => !prev),
      children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: styles_module_default9.cycleButtonText, children: recording ? "Hold a modifier" : formatHoldKey(value) }, recording ? "recording" : value)
    }
  );
}
              ...
              /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: styles_module_default9.settingsSection, children: [
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: styles_module_default9.settingsRow, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: styles_module_default9.settingsLabel, children: [
                    "Output Detail",
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(HelpTooltip, { content: "How much the copied output says about each note. Hover the button to read what the current level includes." })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                    Tooltip,
                    {
                      content: OUTPUT_DETAIL_OPTIONS.find(
                        (opt) => opt.value === settings.outputDetail
                      )?.description ?? "",
                      width: 240,
                      className: styles_module_default9.cycleButtonTooltip,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: styles_module_default9.settingsLabel, children: [
                        "Feedback Shortcut",
                        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(HelpTooltip, { content: "Shortcut that starts and stops feedback mode. Click, then press the keys you want \u2014 modifiers included. Escape cancels." })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                        KeybindField,
                        {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: styles_module_default9.settingsLabel, children: [
                        "Click Through",
                        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(HelpTooltip, { content: "Hold this key to suspend feedback mode and use the page normally \u2014 click a button, open a menu \u2014 without leaving feedback mode. Click, then hold the modifier you want. Backspace turns it off." })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                        HoldKeyField,
                        {
...
function PageFeedbackToolbarCSS({
  ...
  const [showMarkers, setShowMarkers] = (0, import_react9.useState)(true);
  const [isToolbarHidden, setIsToolbarHidden] = (0, import_react9.useState)(() => loadToolbarHidden());
  const [isToolbarHiding, setIsToolbarHiding] = (0, import_react9.useState)(false);
  const portalWrapperRef = (0, import_react9.useRef)(null);
  ...
  const [markersVisible, setMarkersVisible] = (0, import_react9.useState)(false);
  const [markersExiting, setMarkersExiting] = (0, import_react9.useState)(false);
  const [hoverInfo, setHoverInfo] = (0, import_react9.useState)(null);
  const [hoverPosition, setHoverPosition] = (0, import_react9.useState)({ x: 0, y: 0 });
  const [pendingAnnotation, setPendingAnnotation] = (0, import_react9.useState)(null);
  const [copied, setCopied] = (0, import_react9.useState)(false);
  const [sendState, setSendState] = (0, import_react9.useState)("idle");
  const [cleared, setCleared] = (0, import_react9.useState)(false);
  const [isClearing, setIsClearing] = (0, import_react9.useState)(false);
  const [hoveredMarkerId, setHoveredMarkerId] = (0, import_react9.useState)(null);
  const [hoveredTargetElement, setHoveredTargetElement] = (0, import_react9.useState)(null);
  const [hoveredTargetElements, setHoveredTargetElements] = (0, import_react9.useState)([]);
  const [deletingMarkerId, setDeletingMarkerId] = (0, import_react9.useState)(null);
  const [renumberFrom, setRenumberFrom] = (0, import_react9.useState)(null);
  const [editingAnnotation, setEditingAnnotation] = (0, import_react9.useState)(
    null
  );
  const [editingTargetElement, setEditingTargetElement] = (0, import_react9.useState)(null);
  const [editingTargetElements, setEditingTargetElements] = (0, import_react9.useState)([]);
  const [scrollY, setScrollY] = (0, import_react9.useState)(0);
  const [isScrolling, setIsScrolling] = (0, import_react9.useState)(false);
  const [mounted, setMounted] = (0, import_react9.useState)(false);
  const [isFrozen, setIsFrozen] = (0, import_react9.useState)(false);
  const [showSettings, setShowSettings] = (0, import_react9.useState)(false);
  const [showSettingsVisible, setShowSettingsVisible] = (0, import_react9.useState)(false);
  const [settingsPage, setSettingsPage] = (0, import_react9.useState)(
    "main"
  );
  const [tooltipsHidden, setTooltipsHidden] = (0, import_react9.useState)(false);
  const [isDesignMode, setIsDesignMode] = (0, import_react9.useState)(false);
  const [designOverlayExiting, setDesignOverlayExiting] = (0, import_react9.useState)(false);
  const [designPlacements, setDesignPlacements] = (0, import_react9.useState)([]);
  const [activeDesignComponent, setActiveDesignComponent] = (0, import_react9.useState)(null);
  const designPlacementsLoaded = (0, import_react9.useRef)(false);
  const [blankCanvas, setBlankCanvas] = (0, import_react9.useState)(false);
  const [canvasReady, setCanvasReady] = (0, import_react9.useState)(false);
  const [canvasOpacity, setCanvasOpacity] = (0, import_react9.useState)(1);
  const [canvasPurpose, setCanvasPurpose] = (0, import_react9.useState)("new-page");
  const [wireframePurpose, setWireframePurpose] = (0, import_react9.useState)("");
  const [designInteracting, setDesignInteracting] = (0, import_react9.useState)(false);
  const [linkingPlacementId, setLinkingPlacementId] = (0, import_react9.useState)(null);
  const [pendingLink, setPendingLink] = (0, import_react9.useState)(null);
  const [pendingLinkExiting, setPendingLinkExiting] = (0, import_react9.useState)(false);
  const pickTargetRef = (0, import_react9.useRef)(null);
  const [clickThroughHeld, setClickThroughHeld] = (0, import_react9.useState)(false);
  const redispatchingClickRef = (0, import_react9.useRef)(false);
  const [rearrangeState, setRearrangeState] = (0, import_react9.useState)(null);
  const rearrangeLoaded = (0, import_react9.useRef)(false);
  const exploreStashRef = (0, import_react9.useRef)({ rearrange: null, placements: [] });
  const wireframeStashRef = (0, import_react9.useRef)({ rearrange: null, placements: [] });
  const [designDeselectSignal, setDesignDeselectSignal] = (0, import_react9.useState)(0);
  const [rearrangeDeselectSignal, setRearrangeDeselectSignal] = (0, import_react9.useState)(0);
  const [designClearSignal, setDesignClearSignal] = (0, import_react9.useState)(0);
  const [rearrangeClearSignal, setRearrangeClearSignal] = (0, import_react9.useState)(0);
  const designSelectedIdsRef = (0, import_react9.useRef)(/* @__PURE__ */ new Set());
  const rearrangeSelectedIdsRef = (0, import_react9.useRef)(/* @__PURE__ */ new Set());
  const crossDragStartRef = (0, import_react9.useRef)(null);
  const designExitTimer = (0, import_react9.useRef)();
  ...
  const placementAnnotationMap = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  const rearrangeAnnotationMap = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  const rearrangeDebounceTimer = (0, import_react9.useRef)();
  const [isDrawMode, setIsDrawMode] = (0, import_react9.useState)(false);
  const [drawStrokes, setDrawStrokes] = (0, import_react9.useState)([]);
  const drawStrokesRef = (0, import_react9.useRef)(drawStrokes);
  drawStrokesRef.current = drawStrokes;
  const [hoveredDrawingIdx, setHoveredDrawingIdx] = (0, import_react9.useState)(null);
  const drawCanvasRef = (0, import_react9.useRef)(null);
  const isDrawingRef = (0, import_react9.useRef)(false);
  const currentStrokeRef = (0, import_react9.useRef)([]);
  const dimAmountRef = (0, import_react9.useRef)(0);
  const visualHighlightRef = (0, import_react9.useRef)(null);
  const exitingStrokeIdRef = (0, import_react9.useRef)(null);
  const exitingAlphaRef = (0, import_react9.useRef)(1);
  const [tooltipSessionActive, setTooltipSessionActive] = (0, import_react9.useState)(false);
  const tooltipSessionTimerRef = (0, import_react9.useRef)(
    null
  );
  const [pendingMultiSelectElements, setPendingMultiSelectElements] = (0, import_react9.useState)([]);
  const modifiersHeldRef = (0, import_react9.useRef)({ cmd: false, shift: false });
  ...
  const [showEntranceAnimation, setShowEntranceAnimation] = (0, import_react9.useState)(false);
  const toggleTheme = () => {
  ...
  const [currentSessionId, setCurrentSessionId] = (0, import_react9.useState)(
    initialSessionId ?? null
  );
  const sessionInitializedRef = (0, import_react9.useRef)(false);
  const [connectionStatus, setConnectionStatus] = (0, import_react9.useState)(endpoint ? "connecting" : "disconnected");
  const [toolbarPosition, setToolbarPosition] = (0, import_react9.useState)(null);
  const [isDraggingToolbar, setIsDraggingToolbar] = (0, import_react9.useState)(false);
  const [dragStartPos, setDragStartPos] = (0, import_react9.useState)(null);
  const justFinishedToolbarDragRef = (0, import_react9.useRef)(false);
  const [animatedMarkers, setAnimatedMarkers] = (0, import_react9.useState)(
    /* @__PURE__ */ new Set()
  );
  const [exitingMarkers, setExitingMarkers] = (0, import_react9.useState)(/* @__PURE__ */ new Set());
  const [pendingExiting, setPendingExiting] = (0, import_react9.useState)(false);
  const [editExiting, setEditExiting] = (0, import_react9.useState)(false);
  const [isDragging, setIsDragging] = (0, import_react9.useState)(false);
  const mouseDownPosRef = (0, import_react9.useRef)(null);
  const dragStartRef = (0, import_react9.useRef)(null);
  const dragRectRef = (0, import_react9.useRef)(null);
  const highlightsContainerRef = (0, import_react9.useRef)(null);
  const justFinishedDragRef = (0, import_react9.useRef)(false);
  const lastElementUpdateRef = (0, import_react9.useRef)(0);
  const recentlyAddedIdRef = (0, import_react9.useRef)(null);
  const prevConnectionStatusRef = (0, import_react9.useRef)(null);
  const DRAG_THRESHOLD = 8;
  const ELEMENT_UPDATE_THROTTLE = 50;
  const popupRef = (0, import_react9.useRef)(null);
  const editPopupRef = (0, import_react9.useRef)(null);
  const scrollTimeoutRef = (0, import_react9.useRef)(null);
  ...
  const prevDraggingRef = (0, import_react9.useRef)(false);
  (0, import_react9.useEffect)(() => {
  ...
  const hideToolbarTemporarily = (0, import_react9.useCallback)(() => {
  ...
  const wireframeLoaded = (0, import_react9.useRef)(false);
  (0, import_react9.useEffect)(() => {
  ...
  const rearrangeMovedEls = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  ...
  const closeDesignMode = (0, import_react9.useCallback)(() => {
  ...
  const freezeAnimations = (0, import_react9.useCallback)(() => {
    if (isFrozen) return;
    freeze();
    setIsFrozen(true);
  }, [isFrozen]);
  const unfreezeAnimations = (0, import_react9.useCallback)(() => {
    if (!isFrozen) return;
    unfreeze();
    setIsFrozen(false);
  }, [isFrozen]);
  const toggleFreeze = (0, import_react9.useCallback)(() => {
    if (isFrozen) {
      unfreezeAnimations();
    } else {
      freezeAnimations();
  ...
  const createMultiSelectPendingAnnotation = (0, import_react9.useCallback)(() => {
  ...
  const commitLink = (0, import_react9.useCallback)(
    (label) => {
      ...
      setDesignPlacements(
        (prev) => prev.map(
          (p) => p.id === pendingLink.placementId ? { ...p, links: [...p.links ?? [], link] } : p
        )
      );
  ...
  const cancelLink = (0, import_react9.useCallback)(() => {
    setPendingLinkExiting(true);
    originalSetTimeout(() => {
      setPendingLink(null);
      setPendingLinkExiting(false);
  ...
  const startEditAnnotation = (0, import_react9.useCallback)((annotation) => {
  ...
  (0, import_react9.useEffect)(() => {
    ...
    const handleClick = (e) => {
      ...
      if (clickThroughKey && isHoldKeyDown(e, clickThroughKey)) {
        const clickTarget = e.composedPath()[0] || e.target;
  ...
  const fireWebhook = (0, import_react9.useCallback)(
  ...
  const addAnnotation = (0, import_react9.useCallback)(
    (comment) => {
  ...
  const cancelAnnotation = (0, import_react9.useCallback)(() => {
    setPendingExiting(true);
    originalSetTimeout(() => {
      setPendingAnnotation(null);
      setPendingExiting(false);
  ...
  const deleteAnnotation2 = (0, import_react9.useCallback)(
    (id) => {
  ...
  const handleMarkerHover = (0, import_react9.useCallback)(
    (annotation) => {
      if (!annotation) {
        setHoveredMarkerId(null);
        setHoveredTargetElement(null);
  ...
  const updateAnnotation2 = (0, import_react9.useCallback)(
    (newComment) => {
  ...
  const cancelEditAnnotation = (0, import_react9.useCallback)(() => {
    setEditExiting(true);
    originalSetTimeout(() => {
      setEditingAnnotation(null);
      setEditingTargetElement(null);
  ...
  const copyOutput = (0, import_react9.useCallback)(async () => {
...
`;
  ...
  const sendToWebhook = (0, import_react9.useCallback)(async () => {
    const displayUrl = typeof window !== "undefined" ? window.location.pathname + window.location.search + window.location.hash : pathname;
...
`;
  ...
  const handleToolbarMouseDown = (0, import_react9.useCallback)(
    (e) => {
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
            "div",
            {
              ...
              "aria-label": !isActive ? "Start feedback mode" : void 0,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
                  "div",
                  {
                    className: `${styles_module_default4.toggleContent} ${!isActive ? styles_module_default4.visible : styles_module_default4.hidden} ${toolbarPosition && toolbarPosition.y < 100 ? styles_module_default4.tooltipBelow : ""} ${toolbarPosition && toolbarPosition.x < 220 ? styles_module_default4.toggleTooltipAlignLeft : ""} ${tooltipsHidden ? styles_module_default4.tooltipsHidden : ""}`,
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IconListSparkle, { size: 24 }),
                      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: `${styles_module_default4.buttonTooltip} ${styles_module_default4.toggleTooltip}`, children: [
                        "Start feedback mode",
                        settings.activationKey && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: styles_module_default4.shortcut, children: formatKeybind(settings.activationKey) })
                      ] }),
      ...
      pendingLink && (() => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
          AnnotationPopupCSS,
          {
            ...
            lightMode: !isDarkMode,
            accentColor: blankCanvas ? "#f97316" : void 0,
            style: { left, top }
          }
        );
      })(),
